***Idioma***
- 🇪🇸 Español
- [🇺🇸 English](https://github.com/abelcarriizo/torGuide.git)

# Guía de Acceso a la Darknet

¡Bienvenido a la Guía de Acceso a la Darknet! Esta guía te proporcionará información sobre cómo acceder a la darknet de manera segura. Puedes elegir tu sistema operativo y descargar el navegador Tor para comenzar.

## Cómo Acceder a la Darknet

Para ingresar a la darknet, descarga el Navegador Tor. Es una versión modificada de Firefox que permite el acceso a la dark web y está configurado para mayor seguridad.

Puedes obtener el Navegador Tor para Windows, Linux, Mac OS y Android aquí:

[Descargar Navegador Tor](https://www.torproject.org/download/)

Para iOS, se recomienda el navegador Onion Browser:

[Onion Browser para iOS](https://onionbrowser.com/)

## ¿Es Legal Acceder a la Darknet?

Usar Tor es legal en la mayoría de los países. Sin embargo, realizar ciertas actividades, como comprar o vender drogas, armas, dinero falso, etc., es ilegal.

## ¿Qué es Tor?

Tor (The Onion Router) es un software de código abierto que hace rebotar el tráfico de Internet a través de una red mundial de relés para ocultar la ubicación del usuario y protegerlo contra la vigilancia o el análisis de tráfico.

Tor dificulta el rastreo de la actividad en Internet, como visitas a sitios web, publicaciones en línea, mensajes instantáneos y otras formas de comunicación.

## Cómo Funciona Tor

Tu tráfico pasa por 3 nodos intermedios antes de llegar al destino. Cada uno de los 3 nodos tiene una capa de cifrado separada y nadie que observe tu conexión puede leer lo que envías y a dónde.

### Capas de Tor

- Nodo de Guardia: conoce tu dirección IP pero no sabe a dónde te conectas ni qué envías al destino.
- Nodo Intermedio: capa inmediata entre el nodo de guardia y el nodo de salida.
- Nodo de Salida: conoce el destino pero no sabe quién eres.

## ¿Qué es la Darknet?

La web se compone de tres grandes áreas:

- Surface Web: recursos accesibles públicamente, como motores de búsqueda, noticias, redes sociales que pueden ser indexados por motores de búsqueda.
- Deep Web: recursos no indexados por motores de búsqueda porque están protegidos por contraseña o almacenados detrás de servicios públicos, como plataformas internas de empresas, registros médicos, documentos de investigación, documentos legales.
- Dark Web: recursos que solo se pueden acceder con software específico y no son accesibles desde un navegador web estándar, como lugares seguros para informantes, canales de comunicación secretos para activistas, periodistas y defensores de los derechos humanos, pero también muchos mercados y tiendas ilegales.

## ¿Qué son los Servicios Ocultos?

Los servicios ocultos son accesibles solo dentro de la red Tor. Sus nombres de dominio terminan con .onion. No están indexados por ningún motor de búsqueda público. La única forma de ingresar a los sitios .onion es conocer la dirección equivalente.

## Cómo Encontrar Servicios Ocultos

Existen muchas listas de enlaces, wikis y catálogos donde puedes encontrar direcciones de sitios .onion. También hay muchas listas de enlaces en clearnet, pero la mayoría no está actualizada y la mayoría de los enlaces no funcionan.

Es estándar que los servicios ocultos funcionen por un corto período y desaparezcan para siempre.

Existen algunos motores de búsqueda en la darknet, en su mayoría creados por aficionados y son muy limitados debido a la naturaleza de los servicios ocultos.

Antes de acceder a cualquier sitio de la darknet, asegúrate de que sea legal en tu país navegar por el contenido que contienen.

## ¿Quién Creó Tor?

La idea del enrutamiento de cebolla fue creada en 1995 en el Laboratorio de Investigación Naval de los Estados Unidos por David Goldschlag, Mike Reed y Paul Syverson como resultado de una investigación para encontrar una forma de crear conexiones de Internet que no revelaran quién está hablando con quién, con el propósito de proteger las comunicaciones en línea de inteligencia de EE. UU.

A principios de la década de 2000, Roger Dingledine (graduado del MIT) y Paul Syverson comenzaron a trabajar en el proyecto de enrutamiento de cebolla creado en el Laboratorio de Investigación Naval. Para distinguir su trabajo de otros esfuerzos, llamaron al proyecto Tor (The Onion Routing).

Tor se implementó oficialmente en octubre de 2002 y su código fuente se lanzó bajo una licencia de software libre y de código abierto. En diciembre de 2006, los científicos de la computación Roger Dingledine, Nick Mathewson y otros cinco fundaron The Tor Project, una organización sin fines de lucro de investigación y educación responsable de mantener el software.

Tor cuenta con el apoyo del gobierno de EE. UU., muchas ONG, fundaciones privadas, instituciones de investigación, empresas privadas y más de 20,000 donaciones personales de personas de todo el mundo.
